<template>
  <div class="relative flex min-h-screen items-center justify-center theme-page theme-auth-page px-4 pt-32 pb-16 sm:px-6">
    <div class="relative z-10 w-full max-w-lg">
      ...
      <div class="theme-auth-card">
        ...
        <div class="mb-6 text-center">
          ...
          <h1 class="mt-2 text-3xl font-black theme-text-primary">{{ t('auth.register.title') }}</h1>
          <p class="mt-1.5 text-sm theme-text-muted">{{ t('auth.register.subtitle') }}</p>
        </div>

        <form class="theme-auth-form" @submit.prevent="handleRegister">
          <div>
            <label class="mb-1.5 flex items-center gap-1.5 text-xs font-semibold uppercase tracking-[0.18em] theme-text-muted">
