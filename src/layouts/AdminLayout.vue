      ...
      >
        ...
        <div class="border-t border-border">
          <div v-if="!sidebarCollapsed" class="px-6 py-3 text-[11px] text-muted-foreground space-y-1">
            <p>© {{ new Date().getFullYear() }} RSK发卡小店 <span v-if="appVersion" class="text-muted-foreground/70">{{ appVersion }}</span></p>
            <a
              href="https://github.com/BlueSofort/RSK"
              target="_blank"
            ...
            >
              ...
              <span>https://github.com/BlueSofort/RSK</span>
            </a>
          </div>
          <button
            type="button"
