...
var (
	...
	ErrCommentContentEmpty                 = errors.New("comment content empty")
	ErrCommentContentTooLong               = errors.New("comment content too long")
	ErrCommentContentInvalid               = errors.New("comment content invalid")
	ErrCommentSensitiveWords               = errors.New("comment contains sensitive words")
