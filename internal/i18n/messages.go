...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.comment_content_empty":            "评论内容不能为空",
		"error.comment_content_too_long":         "评论内容超出字数限制",
		"error.comment_content_invalid":          "评论内容包含不支持的字符",
		"error.comment_sensitive_words":          "评论内容包含敏感词",
		"error.comment_post_not_found":           "文章不存在",
		"error.comment_not_found":                "评论不存在",
		"error.comment_not_owner":                "无权操作此评论",
		"error.comment_rate_limited":             "评论过于频繁，请稍后再试",
		"error.avatar_cooldown":                  "头像24小时内只能修改一次",
		"error.nickname_cooldown":                "昵称30天内只能修改一次",
	...
	LocaleTW: {
		...
		"error.comment_content_empty":            "評論內容不能為空",
		"error.comment_content_too_long":         "評論內容超出字數限制",
		"error.comment_content_invalid":          "評論內容包含不支援的字元",
		"error.comment_sensitive_words":          "評論內容包含敏感詞",
		"error.comment_post_not_found":           "文章不存在",
		"error.comment_not_found":                "評論不存在",
		"error.comment_not_owner":                "無權操作此評論",
		"error.comment_rate_limited":             "評論過於頻繁，請稍後再試",
		"error.avatar_cooldown":                  "頭像24小時內只能修改一次",
		"error.nickname_cooldown":                "暱稱30天內只能修改一次",
	...
	LocaleEN: {
		...
		"error.comment_content_empty":            "Comment content cannot be empty",
		"error.comment_content_too_long":         "Comment content exceeds character limit",
		"error.comment_content_invalid":          "Comment contains unsupported characters",
		"error.comment_sensitive_words":          "Comment contains sensitive words",
		"error.comment_post_not_found":           "Post not found",
		"error.comment_not_found":                "Comment not found",
		"error.comment_not_owner":                "Not authorized for this comment",
		"error.comment_rate_limited":             "Commenting too frequently, please try later",
		"error.avatar_cooldown":                  "Avatar can only be updated once every 24 hours",
		"error.nickname_cooldown":                "Nickname can only be updated once every 30 days",
